...
optional = ['location', 'distance', 'reference', 'intensity', 'source', 'intensity_stddev']
...
def _get_dyfi_dataframe(detail_or_url):
    ...
    df.loc[df.INTENSITY_STDDEV.isna(),'INTENSITY_STDDEV'] = _compute_stddev_from_nresp(df['NRESP'])
